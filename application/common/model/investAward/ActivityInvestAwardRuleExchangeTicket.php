...
class ActivityInvestAwardRuleExchangeTicket extends Base
{
     ...
     * @access protected
     */
    protected $_table = 'activity_invest_award_rule_exchange_ticket';
    /**
     * 获取奖励兑换券规则
     ...
     * **/
    public function getActivityInvestAwardRuleExchangeTicket($item_id, $rule_id, $item_period_number)
    {
        ...
        if ($info['exchange_ticket_rule'] > 0)
        {
            return $info;
        }
        return FALSE;
